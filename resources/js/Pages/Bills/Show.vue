            ...
            <div
                ...
                <div class="my-2 mt-5 flex  gap-2 items-center p-1">
                    ...
                    <div v-if="bills.active" class=" flex ml-auto gap-2 mb-2 ">
                        ...
                        <Link :href="route('bills.edit', bills)"
                        ...
                        <DangerButton @click="deletebill(bills.id)"
                    ...
                    <div class="flex ml-auto gap-2" v-else>
                        <PrimaryButton @click="restorebill(bills.id)"
                            class="flex justify-center gap-2 rounded-lg bg-green-500 px-2 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-500 sm:px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-x-8 gap-y-6 ">
                    <div
                        ...
                        <div class="flex items-center gap-2 text-pink-700 dark:text-pink-300">
                            ...
                            <p><span class="font-semibold">Tipo:</span> {{ bills.type }}</p>
                        </div>
                         <div class="flex items-center gap-2 text-pink-700 dark:text-pink-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                            ...
                            <p><span class="font-semibold">Doctor:</span> {{ bills.doctor.name }}</p>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-gray-600 dark:text-gray-300">
                            ...
                            <p><span class="font-semibold">Fecha:</span> {{ bills.emission_date }}</p>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-green-600 dark:text-green-400">
                            ...
                            <p><span class="font-semibold">Total:</span> ${{ formatNumber(bills.total) }}</p>
                        </div>
                    </div>

                    <!-- Contenido -->
                    <div>
                        <div v-if="bills.type == 'Contado'">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden mb-6">
                                ...
                                <div class="divide-y divide-gray-200 dark:divide-gray-800">
                                    <div v-for="details in bills.billdetail" :key="details.id"
                                        ...
                                        <div
                                            ...
                                            <div v-if="bills.active && details.active">
                                                <DangerButton @click="deletebillDetail(details.id)"
                                            ...
                                            <button v-else @click="restorebillDetail(details.id)"
...
export default {
    ...
    methods: {
        ...
        deletebillDetail(id) {
            this.$inertia.delete(route('billDetails.destroy', id),);
        },
        restorebillDetail(id) {
            this.$inertia.put(route('billDetails.update', id), {
                active: true
            },
            );
        },
        async print() {
            window.open(route('report.bill', {
                bill: this.bills
            }), '_blank');
        }
    }
