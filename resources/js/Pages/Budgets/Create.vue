        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
                    <h2 class="text-xl font-bold text-white">Nueva Factura/Presupuesto</h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="space-y-1" v-if="form.type == 'Crédito'">
                            ...
                            />
                            <p v-if="errors.expiration_date" class="mt-1 text-xs text-red-600 dark:text-red-400">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-xl shadow-sm mt-6">
                        ...
                        <div v-if="!selectedProcedures.length" class="text-center py-6">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No hay procedimientos</h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Agregue procedimientos para continuar</p>
                        </div>
                        ...
                        <div v-else class="space-y-4">
                            <div v-for="(proc, index) in selectedProcedures" :key="proc.id"
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm font-medium text-gray-500 dark:text-gray-300">#{{ proc.id }}</span>
                                        <h4 class="text-md font-semibold text-gray-800 dark:text-gray-100">{{ proc.name }}</h4>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p v-if="form.errors[`details.${index}.treatment`]" class="text-xs text-red-600 dark:text-red-400">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="form_details[index].amount" type="number" @input="calcTotal(index)"
                                        ...
                                        <p v-if="form.errors[`details.${index}.amount`]" class="text-xs text-red-600 dark:text-red-400">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p v-if="form.errors[`details.${index}.discount`]" class="text-xs text-red-600 dark:text-red-400">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <input v-model="form_details[index].quantity" type="number" @input="calcTotal(index)"
                                            class="block w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-500 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                                            placeholder="1" min="1" />
                                        <p v-if="form.errors[`details.${index}.quantity`]" class="text-xs text-red-600 dark:text-red-400">
                                    ...
                                    <template v-if="form.type == 'Crédito'">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500 dark:text-gray-400">$</span>
                                                <input v-model="form_details[index].initial" type="number" @input="calcTotal(index)"
                                                    class="block w-full pl-8 pr-3 py-2 text-sm border border-gray-300 dark:border-gray-500 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                                                    placeholder="0.00" />
                                            </div>
                                            <p v-if="form.errors[`details.${index}.initial`]" class="text-xs text-red-600 dark:text-red-400">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <input v-model="form_details[index].amount_of_payments" type="number" @input="calcTotal(index)"
                                                class="block w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-500 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                                                placeholder="1" min="1" />
                                            <p v-if="form.errors[`details.${index}.amount_of_payments`]" class="text-xs text-red-600 dark:text-red-400">
                                ...
                                <!-- Procedure Footer -->
                                <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-200 dark:border-gray-500">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        <div v-if="form.total" class="text-lg font-semibold text-gray-900 dark:text-white">
                            Total: <span class="text-blue-600 dark:text-blue-400">{{ formatNumber(form.total) }}</span>
                        </div>
        ...
        <Modal :show="showProcedureModal" @close="showProcedureModal = false" maxWidth="2xl">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button @click="showProcedureModal = false" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                        <XIcon class="h-6 w-6" />
                    </button>
                </div>
                <ProcedureSelector
