...
<template>
    <div class="my-4 mx-4 lg:mx-10">
        ...
        <div class="flex justify-between gap-4">
            <input v-model="searchTerm" type="text" placeholder="Buscar presupuesto..." class="mb-4 w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md
        ...
        <div class="relative overflow-x-auto border border-gray-200 dark:border-gray-700/60 rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr v-for="budget in filteredBudgets" :key="budget.id" class="cursor-pointer text-center" :class="{
