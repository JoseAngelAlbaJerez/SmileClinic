                    ...
                    <div
                        ...
                        <div class="min-w-full overflow-x-auto">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <thead
                                    class="text-xs text-gray-700 uppercase bg-blue-500 text-white dark:bg-gray-800 dark:text-gray-400">
                                    <tr>
                                        <th scope="col"
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="patient in patients.data" :key="patient.id">
                                        ...
                                        <td class="p-4 items-center">
                                            <Link :href="route('patients.show', patient.id)" class="text-blue-500">Abrir</Link>
                                        </td>
