...
export default {
    ...
    methods: {
        submit() {
            ...
            if (this.form.drugs == 1 && this.form.drugs_detail == '') {
                this.error = 'Por favor, asigne un detalle al medicamento.';
                return;
            }
            if (this.form.alergies == 1 && this.form.alergies_detail == '') {
                this.error = 'Por favor, asigne un detalle las alergias.';
                return;
            }
            if (this.form.complications == 1 && this.form.complications_detail == '') {
                this.error = 'Por favor, asigne un detalle a las complicaciones.';
                return;
            }
             if (this.form.drugs == 0 && this.form.drugs_detail !== '') {
                this.form.drugs_detail = '';
                return;
            }
            if (this.form.alergies == 0 && this.form.alergies_detail !== '') {
                 this.form.alergies_detail = '';
                return;
            }
            if (this.form.complications == 0 && this.form.complications_detail !== '') {
                this.form.complications_detail = '';
                return;
            }
