                    ...
                    <div class="my-2 flex mx-10 gap-2 items-center">
                        ...
                        <div class="flex ml-auto items-center gap-2">
                            ...
                            <Link :href="route('payments.create')" as="button"
                                class="flex justify-center gap-2 rounded-lg bg-pink-500 px-2 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-500 sm:px-4">
...
export default {
    ...
    data() {
        return {
            ...
            timeout: 3000,
            crumbs: [
                { icon: markRaw(CartIcon), label: 'Pagos', to: route('payments.index') },
