...
<body>
    <table class="invoice">
        ...
        <tr class="intro">
            <td>
                Paciente: <strong>{{ $bill->patient->first_name ?? '' }}</strong><br>
                Doctor: <strong>{{ $bill->doctor->name ?? '' }}</strong><br>
            ...
            <td>
                ...
                @if ($bill->CXC)
                    <span class="num">Balance:
                        {{ $bill->CXC->balance ? '$' . number_format($bill->CXC->balance, 2) : 'No asignada' }}
                    </span><br>
                @endif
                <span class="num">Tipo:
                    {{ $bill->type }}
            ...
            <td colspan="2">
                <table class="inner-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($bill->billdetail as $index => $detail)
                            <tr>
                                <td>{{ $index + 1 }}</td>
